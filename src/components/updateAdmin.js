...
export default class update extends Component {
    ...
    componentDidMount() {
        axios.get(`https://lirtenhub-na.herokuapp.com/api/admins/`+this.props.match.params.id)
            .then(response => {
                this.setState({
...
onChangeUserpassword(e) {
  this.setState({
    ...
    onSubmit(e) {
        ...
        axios.put(`https://lirtenhub-na.herokuapp.com/api/admins/`+this.props.match.params.id, obj)
