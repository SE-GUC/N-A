...
export default class update extends Component {
    ...
    constructor(props) {
        ...
        this.onChangeBasicInfo = this.onChangeBasicInfo.bind(this);
    ...
    componentDidMount() {
        axios.get(`https://lirtenhub-na.herokuapp.com/api/co_working_spaces/`+this.props.match.params.id)
            .then(response => {
                this.setState({
...
onChangeBasicInfo(e) {
    ...
    onSubmit(e) {
        ...
        axios.put('https://lirtenhub-na.herokuapp.com/api/co_working_spaces/'+this.props.match.params.id, obj)
